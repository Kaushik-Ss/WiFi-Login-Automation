...
from selenium.webdriver.common.keys import send_keys             # For typing the user name and password
...
# If false positives of connection are shown then uncomment line 106
if disConnected():
    login('20I224','20I224')
